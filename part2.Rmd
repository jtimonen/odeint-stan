...
## 1. Simulating data
We generate data using the system defined in [Part 1]('https://github.com/jtimonen/odeint-stan/part1.html'). Noisy observations of **x** are denoted by **y**.
